...
public class MainActivity extends AppCompatActivity implements OnPreparedListener, OnSeekBarChangeListener {
            ...
            if (this.songList.isEmpty()) {
                ...
                this.songView.setOnItemClickListener(new OnItemClickListener() {
                    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                        ...
                        Log.v("Duration",Integer.toString(currSong.getMinutes()));
                    }
                });
    ...
    public int getMagnitudeColor(int minutes) {
    ...
    {
        MainActivity.this.seekBar.getProgressDrawable().setColorFilter(new PorterDuffColorFilter(getMagnitudeColor(currSong.getMinutes()), PorterDuff.Mode.SRC_IN));
        MainActivity.this.seekBar.getThumb().setColorFilter(getMagnitudeColor(currSong.getMinutes()), PorterDuff.Mode.SRC_IN);
    }
